...
class MetroAgi:
    ...
    def baglanti_ekle(self, istasyon1_id: str, istasyon2_id: str, sure: int) -> None:
        if istasyon1_id not in self.istasyonlar or istasyon2_id not in self.istasyonlar:
            return  # Geçersiz istasyonları ekleme
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]:
        ...
        while kuyruk:
            mevcut, yol, mevcut_hat, aktarma_sayisi = kuyruk.popleft()
            ...
            for komsu, _ in mevcut.komsular:
                yeni_aktarma = aktarma_sayisi + (1 if komsu.hat != mevcut_hat else 0)
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        pq = [(0, baslangic.idx, baslangic, [baslangic])]  # idx eklenerek heapq sorunu çözüldü
        ziyaret_edildi = {}
